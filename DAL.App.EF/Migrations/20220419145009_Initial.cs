    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportNeed", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportNeed_Location_DestinationLocationId",
                        column: x => x.DestinationLocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportNeed_Location_StartLocationId",
                        column: x => x.StartLocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportNeed_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableSeatCount = table.Column<int>(type: "integer", nullable: false),
                    Price = table.Column<decimal>(type: "numeric(9,2)", precision: 9, scale: 2, nullable: false),
                    IsAd = table.Column<bool>(type: "boolean", nullable: false),
                    Description = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportOffer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportOffer_Location_DestinationLocationId",
                        column: x => x.DestinationLocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportOffer_Location_StartLocationId",
                        column: x => x.StartLocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportOffer_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransportOffer_Vehicle_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartLocationId = table.Column<Guid>(type: "uuid", nullable: false),
                    DestinationLocationId = table.Column<Guid>(type: "uuid", nullable: false),
                    TransportNeedId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transports_TransportNeed_TransportNeedId",
                        column: x => x.TransportNeedId,
                        principalTable: "TransportNeed",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transports_TransportOffer_TransportOfferId",
                        column: x => x.TransportOfferId,
                        principalTable: "TransportOffer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transports_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TransportOfferId = table.Column<Guid>(type: "uuid", nullable: true),
                    TransportNeedId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedule_Transports_TransportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedule_TransportOfferId",
                table: "Schedule",
                column: "TransportOfferId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportNeed_DestinationLocationId",
                table: "TransportNeed",
                column: "DestinationLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportNeed_StartLocationId",
                table: "TransportNeed",
                column: "StartLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportNeed_UserId",
                table: "TransportNeed",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportOffer_DestinationLocationId",
                table: "TransportOffer",
                column: "DestinationLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportOffer_StartLocationId",
                table: "TransportOffer",
                column: "StartLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportOffer_UserId",
                table: "TransportOffer",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportOffer_VehicleId",
                table: "TransportOffer",
                column: "VehicleId");
